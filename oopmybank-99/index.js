...
async function bankService() {
    ...
    while (condition) {
        ...
        let accountdetail = new BankAccountDetail(customerName.accountnumber1, customerName.initialdeposit);
        let newcustomers = new Customer(customerName.firstname, customerName.lastname, customerName.gender, customerName.age, customerName.mobileNumber, accountdetail);
    ...
    while (condition4) {
        ...
        if (bankapp.options = true) {
            ...
            let accountNumberMatch = customersadd.find(customersadd => customersadd.account.accountNumber === accountNumberInput.accountNumber);
